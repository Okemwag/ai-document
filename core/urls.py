...
urlpatterns = [
    ...
    path(
        "documents/<uuid:id>/", DocumentRetrieveView.as_view(), name="document-retrieve"
    ),
    path(
        "documents/<uuid:id>/improve/",
        DocumentImproveView.as_view(),
        name="document-improve",
    ),
    path(
        "documents/<uuid:id>/export/",
    ...
    path(
        "documents/<uuid:id>/versions/<uuid:version_id>/",
