...
class DocumentViewSetTest(APITestCase):
    ...
    def test_upload_large_file(self):
        ...
        url = reverse("document-upload")
        file = SimpleUploadedFile(
            "test.pdf", b"A" * (11 * 1024 * 1024), content_type="application/pdf"
        )  # 11MB
    ...
    def test_improve_valid_request(self):
        ...
        data = {"improvement_level": "advanced", "focus_areas": ["grammar", "style"]}
    ...
    def test_improve_invalid_focus_area(self):
        ...
        """
        url = reverse("document-improve", args=[self.document.id])
        data = {"improvement_level": "advanced", "focus_areas": ["invalid_area"]}
    ...
    def test_improve_unauthenticated_request(self):
        ...
        self.client.logout()
        url = reverse("document-improve", args=[self.document.id])
        data = {"improvement_level": "basic", "focus_areas": ["grammar"]}
